...
<div class="Entradas">
   ...
   <section class="numerodepost2"></section>
<?php
...
$getNoticias = $conn->prepare("SELECT * FROM noticias WHERE idCategoria ='4' ");
    $getNoticias->execute();
    ...
    foreach ($noticias as $noticia) {
        ...
        if (isset($_SESSION['esadmin']) && $_SESSION['esadmin']){
            ...
            echo'<div class="card2">';
              ...
              echo' <div class="modificarproblemas" style="float:right;  cursor:pointer;  font-size: 20px;font-family:letra2; margin-left: 2em;  margin-right:4em;color:black;" value="'.$noticia['idNoticia'].'"> MODIFICAR</div> ';
                
        echo '<header class="encabezado">';
        echo '<p >
        <span class="fecha">'.$noticia['fechaModificacion'].'</span> on <a class="categoria" >'.$categoria['nombre'].'</a>
        </p>';
        echo ' <form id="formpr-'.$noticia['idNoticia'].'" name="formpr-'.$noticia['idNoticia'].'">'; 
