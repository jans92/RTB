...
$getNoticias = $conn->prepare("SELECT * FROM noticias WHERE idCategoria ='3' ");
    $getNoticias->execute();
    ...
    foreach ($noticias as $noticia) {
        ...
        if (isset($_SESSION['esadmin']) && $_SESSION['esadmin']){
            ...
            echo'<div class="card2">';
              ...
              echo' <div class="modificarjquery" style="float:right;   font-size: 20px; cursor:pointer;font-family:letra2; margin-left: 2em;  margin-right:4em;color:black;" value="'.$noticia['idNoticia'].'"> MODIFICAR</div> ';
